---
title: Cronjob 등록 시 유의사항(PATH)
tags: ['cronjob', 'path-variable']
postDate: 2025-11-29
writer: '@khkim6040'
writer_email: 'khkim6040@postech.ac.kr'
---
...
[POPO](https://popo.poapper.club)는 [let's encrypt](https://letsencrypt.org/)와 [certbot](https://certbot.eff.org/)을 이용해 https 인증서를 관리하고 있다.
